    ...
    <div class="panel-container">
        <ul class="list-group">
            ...
            <?php if ($model->delivery_price > 0) { ?>
                <li class="list-group-item">
                    <?= Yii::t('cart/Order', 'DELIVERY_PRICE') ?>:
                    <strong class="float-right"><?= Yii::$app->currency->number_format($model->delivery_price); ?> <?= $symbol; ?></strong>
                </li>
            <?php } ?>
            <li class="list-group-item">
                <?= Yii::t('cart/default', 'ORDER_PRICE') ?>:
                <strong class="float-right">
                    <span class="total-price"><?= Yii::$app->currency->number_format($model->total_price) ?></span>
                    <span class="text-muted"><?= $symbol ?></span>
                </strong>
            </li>
            <?php if ($model->discount) { ?>
                <li class="list-group-item">
                    ...
                    <?php } else { ?>
                        <strong class="float-right">
                            <?= Yii::$app->currency->number_format($model->discount) ?>
                            <span class="text-muted"><?= $symbol ?></span>
                        </strong>
                    <?php } ?>
                </li>
