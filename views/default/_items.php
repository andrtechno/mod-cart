    ...
    <table class="cart-table">
        ...
        <?php foreach ($items as $index => $product) { ?>
            ...
            <tr id="product-<?= $index; ?>">
                    ...
                    <div class="d-inline-block m-auto">
                        <div class="spinner ">
                            ...
                            <?= Html::textInput("quantities[$index]", $product['quantity'], ['data' => [
                                'step' => (Yii::$app->settings->get('cart', 'quantity_convert')) ? $product['model']->in_box : 1,
                                'min' => (Yii::$app->settings->get('cart', 'quantity_convert')) ? $product['model']->quantity_min : 1,
                                //'max' => 999,
                                'product_id' => $index
                            ]]); ?>
                ...
                <td data-label="<?= Yii::t('default', 'PER_BOX'); ?>">
                    <span class="price"><?= $product['in_box']; ?></span>
                </td>
