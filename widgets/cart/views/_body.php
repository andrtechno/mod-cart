    ...
    <div class="">
        <div class="row">
            <div class="col-md-6 col-sm-12 d-flex align-items-end justify-content-center justify-content-md-start">
                <?= Html::button('<span>' . Yii::t('cart/default', 'BUTTON_CONTINUE_SHOPPING') . '</span>', ['class' => 'btn btn-dark', 'data-dismiss' => 'modal']); ?>
            </div>
            <div class="col-md-6 col-sm-12 text-right" style="">

                <div class="container-checkout-price h3 text-center text-md-right">
                    <span class="cart-total"><?= Yii::$app->currency->number_format($total) ?></span> <?php echo Yii::$app->currency->active['symbol']; ?>
                </div>
                <div class="text-center text-md-right">
                    <?= Html::a(Yii::t('cart/default', 'BUTTON_CHECKOUT'), ['/cart/default/index'], ['class' => 'shop-button enj-add-to-cart-btn engoj-btn-addtocart']); ?>
                </div>
            </div>
        </div>
    </div>
